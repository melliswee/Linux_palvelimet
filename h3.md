...
Lisäksi lopussa on vielä "User Agent", joka kertoo selaimesta, jota asiakas on käyttänyt pyytäessään resurssia eli minun esimerkissä Mozilla/5.0. ja ilmeisesti selviää myös käyttöjärjestelmäni tietoja (Linux x86_64) ja selaimen versio Firefox/91.0.
